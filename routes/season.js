...
router.get("/season/2020/spring", (req, res) => {
    const season_url = "https://api.jikan.moe/v3/season/2020/summer";
...
router.get("/season/:year/:season", (req, res) => {
    ...
    const schedule_url = "https://api.jikan.moe/v3/season/" + year + "/" + season;
